    ...
    int main()
    {
        ...
        fflush(stdin);//Used to clean the output buffer
        scanf("%d",&n);
        system("cls");
    ...
    {
        FILE *fp,*fp1;
        fp=fopen("b.txt","ab");//Open a binary file in append mode for writing at the end of the file.
        fp1=fopen("p.txt","a");//Open a text file in append mode for writing at the end of the file. 
        ...
        fprintf(fp1,"%s ",c.uname);//fprintf is used to print content in file instead of stdout console.
        printf("Enter your password:-\t");
        fflush(stdin);
        scanf("%s",d.pwd);
        printf("Enter your age:-     \t");
        scanf("%d",&d.age);
        fwrite(&d,sizeof(d),1,fp);//For writing in file,it is easy to write string or int to file using fprintf&putc,
        fclose(fp);
        fclose(fp1);
    }
    ...
    int login()
    {
        char u[25],pw[25];
        FILE *fp;
        fp=fopen("b.txt","rb");//Open a binary file for reading. The file must exist.
        printf("\t\tUsername:-  ");
        scanf("%s",u);
        printf("\t\tPassword:-  ");
        fflush(stdin);
        scanf("%s",pw);
        while(!feof(fp))//EOF-->End Of File
        {
    ...
    //Used to calculate the prize money.
    ...
    printf("\t$                         ********                                  $\n");
    printf("\t$                       ************                                $\n");
    printf("\t$                💸💸💸AXIS    BANK💸💸💸      Date :12/11/22      $\n");
    printf("\t$                                                                   $\n");
    printf("\t$   PAY:    %s                                                      $\n",d.username);
    printf("\t$                                                                   $\n");
    printf("\t$                                                                   $\n");
    printf("\t$   RUPEES   %d                                                     $\n",a);
    printf("\t$                                                                   $\n");
    printf("\t$   A/C No:3246634582652    A/C Payee : 🤑🤑🤑🤑🤑🤑🤑🤑        $\n");
    printf("\t$                                                                   $\n");
    printf("\t$                                                                   $\n");
    ...
    //Lower and Upper Diamond for right answer
    void printlowerDiamond()
    {
    ...
    //Lower and Upper Circle for wrong answer
    void printlowercircle()
    {
